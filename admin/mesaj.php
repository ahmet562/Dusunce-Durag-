                    ...
                    <table class="basic-table booking-table">
                        ...
                        <tbody>
                            ...
                            while ($row = $stmt->fetch()) {
                                ...
                                // Mesaj içeriği collapse ile göster
                                echo "<td>
...
$(document).on('change', '.okundu-kontrol', function () {
    ...
    $.post("okundu_guncelle.php", {
        ...
        console.log(response); // geri dönüş kontrolü
    });
});

// Sayfa yüklendiğinde checkbox'ların doğru durumu yansıtılması
$(document).ready(function () {
    $(".okundu-kontrol").each(function () {
        var mesajID = $(this).data('id');
        var checkbox = $(this);
        $.get("get_okundu_durumu.php", { mesajid: mesajID }, function (response) {
            if (response == 1) {
